...
exports.RESPONSE_GENERATION_PROMPT = exports.EMAIL_ANALYSIS_PROMPT = exports.openai = void 0;
exports.analyzeEmail = analyzeEmail;
exports.generateResponse = generateResponse;
exports.generateEmbedding = generateEmbedding;
exports.generateSimpleResponse = generateSimpleResponse;
...
function getCachedAnalysis(emailContent) {
...
function setCachedAnalysis(emailContent, analysis) {
    const key = getCacheKey(emailContent);
...
function optimizeEmailContent(emailContent) {
    ...
    try {
        ...
        const response = await exports.openai.chat.completions.create({
            ...
            messages: [
                ...
                {
                    role: 'user',
                    content: exports.EMAIL_ANALYSIS_PROMPT.replace('{email_content}', optimizedContent)
                }
            ],
            temperature: 0.3,
            max_tokens: 1000
...
async function generateResponse(emailAnalysis, originalEmail, communicationStyle, similarResponses, workflowTemplate) {
    try {
        const prompt = exports.RESPONSE_GENERATION_PROMPT
...
async function generateSimpleResponse(emailAnalysis, emailData) {
    try {
